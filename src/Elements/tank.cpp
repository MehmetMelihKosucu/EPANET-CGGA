...
Tank::Tank(std::string name_, NodeCategory category_) :
    Node(name_, category_), // Use the provided category
    initHead(0.0),
    minHead(0.0),
    maxHead(0.0),
    diameter(0.0),
...
Tank* Tank::clone() const
{
	...
	newTank->volCurve = volCurve;
	newTank->qualSource = qualSource;
	newTank->actualDemand = actualDemand;
	newTank->outflow = outflow;
	newTank->quality = quality;
	newTank->bulkCoeff = bulkCoeff;
	newTank->head = head;
	newTank->volume = volume;
	newTank->area = area;
	newTank->pastHead = pastHead;
	newTank->pastVolume = pastVolume;
	newTank->pastArea = pastArea;
	newTank->pastOutflow = pastOutflow;
	newTank->fullDemand = fullDemand;
	newTank->fixedGrade = fixedGrade;

	return newTank;
}

Tank::Tank(const Tank& other) : Node(other.name, other.category)
{
	this->initHead = other.initHead;
	this->minHead = other.minHead;
	this->maxHead = other.maxHead;
	this->diameter = other.diameter;
	this->minVolume = other.minVolume;
	this->bulkCoeff = other.bulkCoeff;
	this->volCurve = other.volCurve;
	this->maxVolume = other.maxVolume;
	this->volume = other.volume;
	this->area = other.area;
	this->ucfLength = other.ucfLength;
	this->pastHead = other.pastHead;
	this->pastVolume = other.pastVolume;
	this->pastArea = other.pastArea;
	this->pastOutflow = other.pastOutflow;
...
void Tank::initialize(Network* nw)
{
    ...
    fixedGrade = true;
    category = Node::NodeCategory::IT1;  // Tanks are always Independent Type 1
}
